...
Execute a comprehensive Product Requirement Prompt (PRP) for building Model Context Protocol (MCP) servers with authentication, database integration.
...
3. **Implementation Phase**
   ...
   - Follow Python patterns from the existing codebase
